...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ICU Handover Hub — Salisbury District Hospital" },
      {
        name: "description",
        content:
          "Secure intensive care handover for Salisbury District Hospital: track ICU patients, referrals, management, escalation plans and investigations.",
      },
      { name: "author", content: "Salisbury District Hospital ICU" },
      { name: "robots", content: "noindex, nofollow" },
      { name: "apple-mobile-web-app-title", content: "ICU Handover" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:title", content: "ICU Handover Hub — Salisbury District Hospital" },
      ...
      { name: "twitter:title", content: "ICU Handover Hub — Salisbury District Hospital" },
